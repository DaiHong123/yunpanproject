...
<body>
	...
	<div class="filesListHeadBtnsR left">
		<div class="filesListHeadChangBtn" id="filesListHeadChangBtn">
			<span id="clickUpload" class="filesUpLoad"> <i
				class="icon icon-upload"></i>上传
				<form id="formUpload" name="formUploadFile" method="POST"
					enctype="multipart/form-data">
					<input id="fileUpload" type="file" name="uploadFile"
						style="display: none" />
				</form>
			</span> <span class="filesCreate" onclick="createFile()"><i
		...
		<div class="filesListHeadChangChose" id="filesListHeadChangChose">
			<span class="headShare"><i class="icon icon-share"></i>分享</span> <span
				...
				class="headCopy" onclick="copyFile()">复制到</span> <span
	...
	<div class="dialog dialog-fileTreeDialog   dialog-gray"
		...
		<div class="dialog-header dialog-drag">
			<h3>
				<span class="dialog-header-title"><em class="select-text">复制到</em></span>
			</h3>
				...
				<ul class="treeview treeview-content ">
					<li>
						<div class="treeview-node  treeview-node-on treeview-root _minus"
							data-padding-left="0" style="padding-left: 0px;">
							<span class="treeview-node-handler"><em
								class="b-in-blk plus icon-operate minus"></em> <dfn
									class="b-in-blk treeview-ic treeview-dir"></dfn><span
								class="treeview-txt" data-file-path="/">全部文件</span></span>
						</div>
						<ul class="treeview treeview-root-content treeview-content "
							data-padding-left="15">
							<li>
								<div class="treeview-node" data-padding-left="15"
									style="padding-left: 15px;">
									<span class="treeview-node-handler"><em
										class="b-in-blk plus icon-operate "></em> <dfn
											class="b-in-blk treeview-ic treeview-dir"></dfn><span
										class="treeview-txt" data-file-path="/来自：OPPO A59s">来自：OPPO
											A59s</span></span>
								</div>
								<ul class="treeview  treeview-content treeview-collapse"
									data-padding-left="30px"></ul>
							</li>
							<li>
								<div class="treeview-node " data-padding-left="15"
									style="padding-left: 15px;">
									<span class="treeview-node-handler"><em
										class="b-in-blk plus  "></em> <dfn
											class="b-in-blk treeview-ic treeview-dir"></dfn><span
										class="treeview-txt" data-file-path="/我的资源">我的资源</span></span>
								</div>
								<ul class="treeview  treeview-content treeview-collapse"
									data-padding-left="30px"></ul>
							</li>
		...
		<div class="dialog-footer g-clearfix">
			<a class="g-button g-button-large" data-button-id="b77"
				...
				style="float: left; padding-left: 50px;"><span
				class="g-button-right" style="padding-right: 50px;"><span
